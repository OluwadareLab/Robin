...
Rscript Venn_Interactions.r --FileList="/storage/store/mohit/data/cloops/GM12878_chr1.txt":"/storage/store/mohit/data/kr_norm/cloops/GM12878_chr1.txt":"/storage/store/mohit/data/replicate/cloops/GM12878_chr1.txt" --HeaderList=0:0:0 --Labels="Raw":"Normalized":"Replicate" --offset=50 --OutDir="cloops.chr1.venn"
Rscript Venn_Interactions.r --FileList="/storage/store/mohit/data/cloops/GM12878_chr6.txt":"/storage/store/mohit/data/kr_norm/cloops/GM12878_chr6.txt":"/storage/store/mohit/data/replicate/cloops/GM12878_chr6.txt" --HeaderList=0:0:0 --Labels="Raw":"Normalized":"Replicate" --offset=50 --OutDir="cloops.chr6.venn"
echo "ending cLoops plots"


#cLoops2
echo "generating cLoops2 plots"
Rscript Venn_Interactions.r --FileList="/storage/store/mohit/data/cloops2/GM12878_chr1.txt":"/storage/store/mohit/data/kr_norm/cloops2/GM12878_chr1.txt":"/storage/store/mohit/data/replicate/cloops2/GM12878_chr1.txt" --HeaderList=0:0:0 --Labels="Raw":"Normalized":"Replicate" --offset=50 --OutDir="cloops2.chr1.venn"
Rscript Venn_Interactions.r --FileList="/storage/store/mohit/data/cloops2/GM12878_chr6.txt":"/storage/store/mohit/data/kr_norm/cloops2/GM12878_chr6.txt":"/storage/store/mohit/data/replicate/cloops2/GM12878_chr6.txt" --HeaderList=0:0:0 --Labels="Raw":"Normalized":"Replicate" --offset=50 --OutDir="cloops2.chr6.venn"
